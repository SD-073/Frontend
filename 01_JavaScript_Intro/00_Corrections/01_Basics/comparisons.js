...
console.log('5 == "5": ', 5 == '5'); // Loose equality, true
console.log('5 === "5": ', 5 === '5'); // Strict equality, false

console.log('10 != "10": ', 10 != '10'); // Loose inequality, false
console.log('10 !== "10": ', 10 !== '10'); // Strict inequality, true
