...
age = 26; // age can be reassigned because it was declared with let.

// Reassign the value of name to "Jane Doe".
name = 'Jane Doe'; // name can be reassigned because it was declared with let.
...
// birthYear and isStudent cannot be reassigned because they were declared with const. An error is thrown if you try to change their values.
